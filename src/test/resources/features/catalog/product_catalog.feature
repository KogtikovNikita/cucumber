Feature: Product Catalog
    ...
    Rule: Customers should be able to search for products by name
        ...
        Example: The one where Sally searches for a more general term. e. g. saw
            Given Sally is on the home page
    ...
    Rule: Customers should be able to narrow down their search by category
        Example: The one where Sally wants to see Hand Saws
            Given Sally is on the home page
            When she searches for "saw"
